...
import com.jakewharton.rxbinding3.internal.AlwaysTrue.invoke
import com.tavish.musicplayerbeat.R
import kotlinx.android.synthetic.main.layout_vertical_seekbar.view.*
import kotlin.math.max
import kotlin.math.roundToInt


open class BeatRangeBarView constructor(context: Context, attrs: AttributeSet) : FrameLayout(context, attrs) {

    companion object {
        private const val DEFAULT_MAX_VALUE = 31
    ...
    private var mOnBeatRangeBarListener: ((Int) -> Unit)? = null
  //  private var mOnBeatRangeBarListener:OnBeatRangeBarListener? = null
    ...
    var progress: Int = 50
        set(value) {
            ...
            if (field != newValue) {
                mOnBeatRangeBarListener?.invoke(newValue)
    ...
    private fun init(context: Context, attrs: AttributeSet) {
        inflate(context, R.layout.layout_vertical_seekbar, this)
    ...
    fun setOnProgressChangeListener(listener: ((Int) -> Unit)?) {
        this.mOnBeatRangeBarListener = listener
    }
