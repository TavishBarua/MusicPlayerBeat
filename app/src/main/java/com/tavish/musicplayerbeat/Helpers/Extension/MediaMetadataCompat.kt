package com.tavish.musicplayerbeat.Helpers.Extension

import android.graphics.Bitmap
import android.net.Uri
import android.support.v4.media.MediaBrowserCompat.MediaItem
import android.support.v4.media.MediaMetadataCompat
import com.tavish.musicplayerbeat.Helpers.MediaHelpers.toUri
import com.tavish.musicplayerbeat.Utils.Constants.Companion.METADATA_KEY_BEAT_FLAGS
...
inline val MediaMetadataCompat.flag
    get() = this.getLong(METADATA_KEY_BEAT_FLAGS).toInt()
...
inline var MediaMetadataCompat.Builder.flag: Int
    ...
    get() = throw IllegalAccessException("Cannot get from MediaMetadataCompat.Builder")
    set(value) {
        putLong(METADATA_KEY_BEAT_FLAGS, value.toLong())
    }
